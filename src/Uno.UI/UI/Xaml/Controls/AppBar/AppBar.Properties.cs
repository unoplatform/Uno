...
namespace Windows.UI.Xaml.Controls
{
	partial class AppBar
	{
		...
		{
			get { return (AppBarTemplateSettings)this.GetValue(TemplateSettingsProperty); }
			set { this.SetValue(TemplateSettingsProperty, value); }
		}
		public static DependencyProperty TemplateSettingsProperty { get; } =
			DependencyProperty.Register(nameof(TemplateSettings), typeof(AppBarTemplateSettings), typeof(AppBar), new PropertyMetadata(null));
		#endregion
	}
}
